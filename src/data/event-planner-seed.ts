...
export const seededTasks: PlannerTask[] = [
  {
    ...
    dueDate: '2026-04-20',
    status: 'Pending',
    notes: 'Legal review is complete, waiting on countersignature.',
  ...
  },
  {
    ...
    dueDate: '2026-04-23',
    status: 'Pending',
    notes: 'Need final dimensions from venue operations.',
  ...
  },
  {
    ...
    dueDate: '2026-05-22',
    status: 'Completed',
    notes: 'Email drafted and approved by marketing.',
  ...
  },
  {
    ...
    dueDate: '2026-04-25',
    status: 'Pending',
    notes: 'Waiting on pricing from three vendors.',
...
export const seededRsvps: PlannerRsvp[] = [
  {
    ...
    status: 'Going',
    notes: 'Needs accessible parking.',
    source: 'public',
    updatedAt: '2026-04-13T13:20:00.000Z',
  },
  {
    id: 'rsvp-002',
    eventId: 'event-001',
  ...
  },
  {
    ...
    status: 'Going',
    notes: 'Bringing a guest from the sponsor team.',
    source: 'internal',
