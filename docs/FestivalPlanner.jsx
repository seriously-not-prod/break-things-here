...
const can = (u, p) => {
  ...
  return (
    ps.includes('all') || ps.includes(p) || (p.endsWith('.r') && ps.includes(p.replace('.r', '.w')))
  );
};
...
const INIT_EVENTS = [
  {
    ...
    capacity: 5000,
    status: 'Upcoming',
    description: 'Annual summer music festival featuring top international artists and bands.',
    budget: 250000,
    color: T.primary,
    deleted: false,
  ...
  },
  {
    ...
    capacity: 2000,
    status: 'Upcoming',
    description: 'Premier technology conference for developers and innovators.',
    budget: 150000,
    color: T.violet,
    deleted: false,
  ...
  },
  {
    ...
    capacity: 500,
    status: 'Upcoming',
    description: 'Annual charity fundraising gala with dinner and auction.',
    budget: 80000,
    color: T.green,
    deleted: false,
  ...
  },
  {
    ...
    capacity: 800,
    status: 'Completed',
    description: 'Intimate jazz and blues concert evening.',
    budget: 45000,
    color: T.cyan,
    deleted: false,
...
const INIT_BUDGET = [
  {
    ...
    allocated: 80000,
    spent: 75000,
    description: 'Central Park permit and stage setup',
  },
  {
    id: 'b2',
    eventId: 'e1',
    ...
    allocated: 100000,
    spent: 95000,
    description: 'Artist fees and sound/light equipment',
  },
  {
    id: 'b3',
    eventId: 'e1',
  ...
  },
  {
    ...
    allocated: 30000,
    spent: 28000,
    description: 'Social media and print advertising',
  },
  {
    id: 'b5',
    eventId: 'e2',
  ...
  },
  {
    ...
    allocated: 30000,
    spent: 15000,
    description: 'Conference lunch and coffee breaks',
  },
  {
    id: 'b7',
    eventId: 'e2',
    ...
    allocated: 20000,
    spent: 12000,
    description: 'Digital and print promotion',
  },
  {
    id: 'b8',
    eventId: 'e3',
  ...
  },
  {
    ...
    allocated: 20000,
    spent: 19500,
    description: 'Floral arrangements and lighting',
  },
  {
    id: 'b10',
    eventId: 'e3',
    ...
    allocated: 25000,
    spent: 18000,
    description: 'Gala dinner and drinks',
  },
  {
    id: 'b11',
    eventId: 'e4',
    ...
    allocated: 15000,
    spent: 14000,
    description: 'Blue Note venue rental',
  },
  {
    id: 'b12',
    eventId: 'e4',
...
const fmtD = (d, locale) => {
  ...
  try {
    return d
      ? new Date(d).toLocaleDateString(loc, { month: 'short', day: 'numeric', year: 'numeric' })
      : '';
  } catch {
    return d || '';
  }
...
const Btn = ({ children, onClick, variant = 'primary', size = 'md', disabled, style: sx = {} }) => {
  ...
  return (
    <button
      ...
      disabled={disabled}
      style={{ ...base, ...vars[variant], padding: pad, fontSize: fs, opacity: disabled ? 0.5 : 1 }}
    >
      {children}
    </button>
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3 id="modal-title" style={{ margin: 0, fontSize: 17, fontWeight: 800, color: T.text }}>
            {title}
          </h3>
          <button
            type="button"
...
const StatCard = ({ icon: Icon, label, value, sub, color, glow }) => (
  ...
  >
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
      <div style={{ background: glow, borderRadius: 12, padding: 10, display: 'flex' }}>
    ...
    >
      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 60 }}>
            ...
            >
              <Zap size={22} color={T.primary} />
            </div>
            <span
              style={{ fontSize: 22, fontWeight: 800, color: T.text, letterSpacing: '-0.02em' }}
            >
              Festivo
            </span>
          </div>
          ...
          <p style={{ fontSize: 15, color: T.textSub, lineHeight: 1.7, margin: '0 0 40px' }}>
            The all-in-one platform for event management, guest tracking, and budget planning.
          </p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 40 }}>
            {[
              { icon: '🎪', text: 'Manage events & guests effortlessly' },
              { icon: '📊', text: 'Track budgets with real-time alerts' },
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, paddingTop: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {DEMO_USERS.map((u) => (
              ...
              >
                <span style={{ fontWeight: 700, color: ROLE_META[u.role].color }}>
      ...
      >
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <p style={{ fontSize: 14, color: T.textSub, marginBottom: 32 }}>
    ...
    >
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <Card style={{ padding: 32 }}>
          ...
          <p style={{ fontSize: 13, color: T.textSub, margin: '0 0 28px' }}>
...
const Dashboard = ({ events, guests, budget, user }) => {
  ...
  const monthlyData = [
    { month: 'Jan', events: 1, guests: 45 },
    { month: 'Feb', events: 2, guests: 78 },
    { month: 'Mar', events: 1, guests: 32 },
    { month: 'Apr', events: 3, guests: 120 },
    { month: 'May', events: 2, guests: 89 },
    { month: 'Jun', events: 4, guests: 210 },
  ];
    ...
    <div style={{ padding: 28, maxWidth: 1400 }}>
      ...
      >
        <StatCard
          icon={Calendar}
          label="Active Events"
          value={activeEvents.filter((e) => e.status !== 'Completed').length}
          sub={`${activeEvents.length} total events`}
          color={T.primary}
          glow={T.primaryGlow}
        />
        <StatCard
        ...
        <StatCard
          icon={UserCheck}
          label="RSVP Rate"
          value={`${pct(confirmed, totalGuests)}%`}
        ...
        <StatCard
          icon={DollarSign}
          label="Total Budget"
          value={fmtC(totalBudget)}
          sub={`${fmtC(totalSpent)} spent (${pct(totalSpent, totalBudget)}%)`}
          color={T.cyan}
          glow={T.cyanGlow}
        />
      </div>
      ...
      <div
        style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20, marginBottom: 24 }}
      >
        {/* RSVP Pie */}
        <Card>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={budgetByCat} barSize={16}>
              ...
              <Legend
                iconType="circle"
                iconSize={8}
                wrapperStyle={{ fontSize: 12, color: T.textSub }}
              />
            </BarChart>
          </ResponsiveContainer>
        </Card>
        ...
        <Card>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {upcomingEvents.length === 0 && (
              <p style={{ color: T.textSub, fontSize: 13 }}>No upcoming events.</p>
            )}
              ...
              >
                ...
                <div style={{ flex: 1, overflow: 'hidden' }}>
                  ...
                  <div style={{ fontSize: 11, color: T.textSub }}>
                    {fmtD(e.date)} · {e.location.split(',')[0]}
                  </div>
                </div>
                <Badge
                  label={e.status}
                  color={STATUS_COLORS[e.status]}
                  bg={`${STATUS_COLORS[e.status]}22`}
                />
              </div>
            ))}
          </div>
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        ...
        <Sel label="Type" value={f.type} onChange={(e) => up('type', e.target.value)}>
          {EVENT_TYPES.map((t) => (
            <option key={t}>{t}</option>
          ))}
        </Sel>
        <Sel label="Status" value={f.status} onChange={(e) => up('status', e.target.value)}>
          ...
          {COLORS.map((c) => (
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                background: c,
                border: f.color === c ? `3px solid ${T.text}` : '3px solid transparent',
                cursor: 'pointer',
              }}
            />
          ))}
        ...
        <Btn
          onClick={async () => {
            ...
            const dup = events.find(
              (ev) =>
                ev.id !== f.id &&
                ev.title.trim().toLowerCase() === f.title.trim().toLowerCase() &&
                ev.date === f.date,
            );
...
const Events = ({ events, setEvents, toast, user, regionFilterState }) => {
  ...
  const list = events.filter((e) => {
    ...
    const regionMatch =
      regionFilter === 'all' || (e.location || '').split(',').slice(-1)[0].trim() === regionFilter;
  ...
  const saveEvent = (f) => {
    if (modal === 'create') {
      setEvents((p) => [
        ...p,
        { ...f, id: uid(), deleted: false, createdAt: new Date().toISOString() },
      ]);
  ...
  const del = (id) => {
    setEvents((p) => p.map((e) => (e.id === id ? { ...e, deleted: true } : e)));
    toast('Event deleted', 'warning');
  };
  const restore = (id) => {
    setEvents((p) => p.map((e) => (e.id === id ? { ...e, deleted: false } : e)));
    toast('Event restored', 'success');
  };
  const permdel = (id) => {
    setEvents((p) => p.filter((e) => e.id !== id));
    toast('Event permanently deleted', 'error');
  };
      ...
      >
        ...
        >
          ...
          {[
            ...new Set(
              events
                .map((ev) => (ev.location || '').split(',').slice(-1)[0].trim())
                .filter(Boolean),
            ),
          ].map((r) => (
            <option key={r} value={r}>
        ...
        <Btn variant="subtle" size="sm" onClick={() => setShowDeleted((p) => !p)}>
          <Trash2 size={14} />
              ...
              <div style={{ padding: 20 }}>
                ...
                >
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <Clock size={12} />
                    {fmtD(e.date)}
                    {e.endDate && e.endDate !== e.date && ` — ${fmtD(e.endDate)}`}
                  </span>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <MapPin size={12} />
                    {e.location}
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <Users size={12} />
                    {e.capacity} capacity · <DollarSign size={12} />
                    {fmtC(e.budget)} budget
                  </span>
                </div>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {e.deleted ? (
                    <>
                      <Btn variant="ghost" size="sm" onClick={() => restore(e.id)}>
                        <RotateCcw size={13} />
                        Restore
                      </Btn>
                      <Btn variant="danger" size="sm" onClick={() => permdel(e.id)}>
                        <Trash2 size={13} />
                        Delete Forever
                      </Btn>
                    </>
                    ...
                    <>
                      {can(user, 'events.w') && (
                        <Btn variant="ghost" size="sm" onClick={() => setModal(e)}>
                          <Edit2 size={13} />
                          Edit
                        </Btn>
                      )}
                      {can(user, 'events.w') && (
                        <Btn variant="subtle" size="sm" onClick={() => del(e.id)}>
                          <Trash2 size={13} />
                          Delete
                        </Btn>
                      )}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 0' }}>
          <input
            ...
            id="po"
            checked={f.plusOne}
            onChange={(e) => up('plusOne', e.target.checked)}
            style={{ width: 16, height: 16, cursor: 'pointer' }}
          />
          <label htmlFor="po" style={{ fontSize: 13, color: T.textSub, cursor: 'pointer' }}>
            Has +1 guest
          </label>
        </div>
      </div>
...
const Guests = ({ guests, setGuests, events, toast, user }) => {
  ...
  const saveGuest = (f) => {
    if (modal === 'create') {
      setGuests((p) => [...p, { ...f, id: uid(), checkedIn: false }]);
      toast('Guest added!', 'success');
    } else {
      setGuests((p) => p.map((g) => (g.id === modal.id ? { ...g, ...f } : g)));
  ...
  const del = (id) => {
    ...
    toast('Guest removed', 'warning');
  };
  const toggleCheckIn = (id) => {
    setGuests((p) => p.map((g) => (g.id === id ? { ...g, checkedIn: !g.checkedIn } : g)));
  };
  const updateRSVP = (id, rsvp) => {
    setGuests((p) => p.map((g) => (g.id === id ? { ...g, rsvp } : g)));
    toast(`RSVP updated to ${rsvp}`, 'success');
  };
  ...
  return (
    <div style={{ padding: 28, maxWidth: 1400 }}>
            ...
            <tbody>
              {list.length === 0 && (
                <tr>
                  <td
                    colSpan={7}
                    style={{ padding: 40, textAlign: 'center', color: T.textSub, fontSize: 14 }}
                  >
                    No guests found.
                  </td>
                </tr>
              ...
              {list.map((g, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 16px', fontSize: 12, color: T.textSub }}>
                      {ev?.title || '—'}
                    </td>
                    <td style={{ padding: '12px 16px' }}>
                      {can(user, 'guests.w') ? (
                        <select
                          ...
                          style={{
                            background: 'transparent',
                            border: `1px solid ${STATUS_COLORS[g.rsvp]}44`,
                            borderRadius: 8,
                            padding: '4px 8px',
                            color: STATUS_COLORS[g.rsvp],
                            fontSize: 12,
                            fontFamily: 'inherit',
                            fontWeight: 700,
                            cursor: 'pointer',
                        ...
                        >
                          {RSVP_STATUSES.map((s) => (
                            <option key={s} value={s} style={{ color: T.text, background: T.card }}>
                              {s}
                            </option>
                          ))}
                        </select>
                    ...
                    <td
                      style={{
                        padding: '12px 16px',
                        fontSize: 12,
                        color: g.plusOne ? T.green : T.textDim,
                      }}
                    >
                      {g.plusOne ? 'Yes' : 'No'}
                    </td>
                    <td style={{ padding: '12px 16px' }}>
                      {can(user, 'guests.w') ? (
                        <button
                          ...
                          style={{
                            background: g.checkedIn ? T.greenGlow : 'transparent',
                            border: `1px solid ${g.checkedIn ? T.green : T.border}`,
                            borderRadius: 8,
                            padding: '5px 12px',
                            color: g.checkedIn ? T.green : T.textSub,
                            fontSize: 12,
                            cursor: 'pointer',
                            fontFamily: 'inherit',
                            fontWeight: 600,
                        ...
                        <span style={{ fontSize: 12, color: g.checkedIn ? T.green : T.textSub }}>
      ...
      {modal && (
        <Modal
          title={modal === 'create' ? 'Add Guest' : 'Edit Guest'}
          onClose={() => setModal(null)}
        >
          <GuestForm
            guest={modal !== 'create' ? modal : null}
            events={events}
            onSave={saveGuest}
            onClose={() => setModal(null)}
          />
...
const BudgetForm = ({ item, events, onSave, onClose }) => {
  ...
  const submit = async () => {
    ...
    try {
      await new Promise((r) => setTimeout(r, 300));
      onSave({ ...f, allocated: +f.allocated, spent: +f.spent });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        <Inp
          ...
          type="number"
          value={f.allocated}
          onChange={(e) => up('allocated', e.target.value)}
          placeholder="50000"
          error={errs.allocated}
        />
        <Inp
          label="Spent ($)"
          type="number"
...
const Budget = ({ budget, setBudget, events, toast, user }) => {
  ...
  const saveBudget = (f) => {
    ...
    if (modal === 'create') {
      setBudget((p) => [...p, { ...data, id: uid() }]);
      toast('Budget item added!', 'success');
    } else {
      setBudget((p) => p.map((b) => (b.id === modal.id ? { ...b, ...data } : b)));
    ...
    <div style={{ padding: 28, maxWidth: 1400 }}>
      {overBudget && (
        ...
        >
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 700, color: T.amber }}>
              Budget Alert — {usagePct}% Used
            </div>
            <div style={{ fontSize: 12, color: T.textSub }}>
              You have used over 90% of your allocated budget. Review expenses.
            </div>
          </div>
        </div>
      )}
      ...
      >
        {[
          ...
          { l: 'Remaining', v: fmtC(totalRemaining), c: T.cyan },
          {
            l: 'Usage',
            v: `${usagePct}%`,
            c: usagePct >= 90 ? T.red : usagePct >= 70 ? T.amber : T.green,
          },
        ].map((s) => (
          <div
            key={s.l}
      ...
      <Card style={{ marginBottom: 24, padding: 20 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 700, color: usagePct >= 90 ? T.red : T.green }}>
            {usagePct}%
          </span>
        </div>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {list.length === 0 && (
                <tr>
                  <td colSpan={8} style={{ padding: 40, textAlign: 'center', color: T.textSub }}>
              ...
              {list.map((b) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '12px 16px' }}>
                      <Badge label={b.category} color={T.cyan} bg={T.cyanGlow} />
                    </td>
                    <td
                      style={{ padding: '12px 16px', fontSize: 13, fontWeight: 700, color: T.text }}
                    >
                      {fmtC(b.allocated)}
                    </td>
                    <td
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        >
                          <div
                            style={{
                              height: '100%',
                              background: u >= 90 ? T.red : u >= 70 ? T.amber : T.green,
                              width: `${u}%`,
                              borderRadius: 4,
                            }}
                          />
      ...
      {modal && (
        <Modal
          title={modal === 'create' ? 'Add Budget Item' : 'Edit Budget Item'}
          onClose={() => setModal(null)}
        >
          <BudgetForm
...
const SettingsPage = ({ user, setUser, toast }) => {
  ...
  const changePwd = () => {
    if (pwds.next !== pwds.confirm) {
      toast("Passwords don't match", 'error');
      return;
    }
    if (pwds.next.length < 6) {
  ...
  return (
    <div style={{ padding: 28, maxWidth: 800 }}>
      ...
      {tab === 'security' && (
        <Card>
          <h3 style={{ margin: '0 0 24px', fontSize: 16, fontWeight: 700, color: T.text }}>
            Change Password
          </h3>
          <Inp
            ...
            type="password"
            value={pwds.current}
            onChange={(e) => setPwds((p) => ({ ...p, current: e.target.value }))}
          />
          <Inp
            label="New Password"
            type="password"
            value={pwds.next}
            onChange={(e) => setPwds((p) => ({ ...p, next: e.target.value }))}
          />
          <Inp
            label="Confirm New"
            type="password"
            value={pwds.confirm}
            onChange={(e) => setPwds((p) => ({ ...p, confirm: e.target.value }))}
          />
          <Btn onClick={changePwd} variant="violet">
            Update Password
          </Btn>
          ...
          <div style={{ marginTop: 32, paddingTop: 24, borderTop: `1px solid ${T.border}` }}>
            ...
            {[{ device: 'Chrome · Windows', loc: 'Mumbai, IN', time: 'Now (current)' }].map(
              (s, i) => (
                <div
                  key={i}
                  style={{
      ...
      {tab === 'roles' && (
        <Card>
          <h3 style={{ margin: '0 0 20px', fontSize: 16, fontWeight: 700, color: T.text }}>
            Role Permissions
          </h3>
            ...
            {ROLES.map((r) => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                  ...
                  />
                  {user.role === r && (
                    <span style={{ fontSize: 11, color: T.textDim }}>(Your role)</span>
                  )}
                </div>
      ...
      {tab === 'about' && (
        <Card>
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            >
              <Zap size={32} color={T.primary} />
            </div>
            <h2 style={{ fontSize: 22, fontWeight: 900, color: T.text, margin: '0 0 6px' }}>
              Festivo
            </h2>
            <p style={{ fontSize: 13, color: T.textSub, margin: '0 0 24px' }}>
              Festival & Event Planner · v1.0.0
            </p>
            <div
              style={{
                display: 'flex',
            ...
            >
              {[
                ['Events', 'Create & manage events with full lifecycle'],
                ['Guests', 'Track RSVPs, dietary needs & check-ins'],
                ['Budget', 'Plan budgets & track spending in real-time'],
                ['RBAC', 'Role-based access for your entire team'],
              ].map(([h, d]) => (
                <div
                  key={h}
                  style={{
                ...
                >
                  ...
                  <div>
                    <div style={{ fontSize: 12, fontWeight: 700, color: T.text }}>{h}</div>
...
export default function App() {
  ...
  const [locale, setLocale] = useState(() =>
    store.g('festivo_locale', (typeof navigator !== 'undefined' && navigator.language) || 'en-US'),
  );
  ...
  useEffect(() => {
    store.s('festivo_events', events);
  }, [events]);
  useEffect(() => {
    store.s('festivo_guests', guests);
  }, [guests]);
  useEffect(() => {
    store.s('festivo_budget', budget);
  }, [budget]);
  useEffect(() => {
    store.s('festivo_users', users);
  }, [users]);
  useEffect(() => {
    store.s('festivo_locale', locale);
    window.__FESTIVO_LOCALE = locale;
  }, [locale]);
  useEffect(() => {
    store.s('festivo_region', region);
  ...
  if (view === 'register')
    return (
      <>
        <RegisterPage onRegister={handleRegister} onGoLogin={() => setView('login')} />
        <ToastContainer toasts={toasts} />
      </>
    );
    ...
    >
      ...
      >
        ...
        <main style={{ flex: 1, overflowY: 'auto' }}>
          {page === 'dashboard' && (
            <Dashboard events={events} guests={guests} budget={budget} user={user} />
          )}
          {page === 'events' && (
            <Events events={events} setEvents={setEvents} toast={toast} user={user} />
          )}
          {page === 'guests' && (
            <Guests
              guests={guests}
