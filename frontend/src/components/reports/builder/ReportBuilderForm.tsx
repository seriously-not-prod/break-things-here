  ...
  return (
    <FormProvider {...methods}>
      <main aria-labelledby="builder-heading" style={{ maxWidth: '900px', padding: '24px' }}>
        <h1
          id="builder-heading"
          style={{ fontSize: '1.4rem', fontWeight: 700, marginBottom: '24px' }}
        >
        ...
        <form noValidate>
          ...
          <section aria-labelledby="format-heading" style={{ marginBottom: '20px' }}>
            <fieldset style={{ border: 'none', padding: 0, margin: 0 }}>
              <legend id="format-heading" style={{ fontWeight: 600, marginBottom: '6px' }}>
                Output Format
              </legend>
                ...
                <div style={{ flex: 1, minWidth: '240px' }}>
                  ...
                  <input
                    ...
                    style={{
                      ...
                      padding: '6px 10px',
                      borderRadius: '4px',
                      border: `1px solid ${errors.recipients ? '#dc2626' : '#d1d5db'}`,
                    }}
                  />
                  {errors.recipients && (
                    <p
                    ...
                    >
                      {Array.isArray(errors.recipients)
                        ? (errors.recipients as Array<{ message?: string } | undefined>)
                            .filter(Boolean)
                            .map((e) => e?.message)
                            .filter(Boolean)
                            .join(', ') || 'Invalid email address.'
          ...
          {statusMsg && (
            <p
              ...
              style={{
                marginTop: '12px',
                fontSize: '0.9rem',
                color: statusMsg.startsWith('Error') ? '#dc2626' : '#059669',
              }}
            >
              {statusMsg}
            </p>
